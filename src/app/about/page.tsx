    ...
    <>
      <section className="bg-primary text-primary-foreground py-20 md:py-28 text-center animate-fade-in-down">
        <div className="container mx-auto px-4">
          <h1 className="font-headline text-4xl md:text-5xl font-bold">About Ar Constructions and Real Estate</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="animate-slide-in-from-right">
              ...
              <p className="text-muted-foreground mb-4" style={{ animationDelay: '0.2s' }}>
                Ar Constructions and Real Estate was founded with a simple yet powerful mission: to build structures that are not only aesthetically pleasing but also durable and functional. Over the years, we have grown from a small local firm into a leading construction company, renowned for our commitment to excellence and client satisfaction.
              </p>
